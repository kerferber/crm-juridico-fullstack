  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-border/60 bg-white px-5 py-5 shadow-sm dark:border-dark-border/60 dark:bg-dark-card/80">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1.5">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-foreground dark:text-dark-foreground">
              Priorize o que move os processos hoje
            </h1>
          ...
          <div className="flex flex-wrap gap-2">
            <Button className="gap-2 rounded-full" onClick={openTaskModal}>
          ...
          {[
            {
              ...
              description:
                metrics.dueToday === 0 ? 'Nenhum prazo para hoje' : 'Com entrega prevista para hoje',
              icon: CalendarDays,
            ...
            },
            {
              ...
              description:
                metrics.overdue === 0 ? 'Tudo em dia' : 'Precisa de replanejamento urgente',
              icon: AlertTriangle,
              action: () => setActiveTab('all'),
              actionLabel: 'Abrir lista',
              accent: 'text-rose-600 bg-rose-50 dark:text-rose-200 dark:bg-rose-500/10',
            },
            {
              ...
              description:
                upcomingSevenDays === 0
                  ? 'Sem entregas na próxima semana'
                  : 'Antecipe o que vem por aí',
              icon: CheckCircle2,
              action: () => setActiveTab('week'),
              actionLabel: 'Ver semana',
              accent: 'text-sky-600 bg-sky-50 dark:text-sky-200 dark:bg-sky-500/10',
            },
          ].map(card => (
            <div
              key={card.title}
            ...
            >
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="justify-start px-0 text-xs font-semibold"
                onClick={card.action}
              >
                {card.actionLabel}
              </Button>
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-border/60 bg-surface px-4 py-4 shadow-sm dark:border-dark-border/60 dark:bg-dark-surface/60">
            ...
            <p className="text-xs text-muted-foreground">
              Tarefas aguardando delegação direta.
            </p>
          </div>
          <div className="rounded-2xl border border-border/60 bg-surface px-4 py-4 shadow-sm dark:border-dark-border/60 dark:bg-dark-surface/60">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted-foreground">
        ...
        <div className="mt-6 space-y-4 rounded-2xl border border-border/60 bg-surface px-4 py-4 shadow-sm dark:border-dark-border/60 dark:bg-dark-surface/60">
