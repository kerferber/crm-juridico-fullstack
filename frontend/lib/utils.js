...
const getGamificationData = (user, tasks, lawsuits) => {
  ...
  const progressPercentage = nextLevel ? (score - level.pointsRequired) / (nextLevel.pointsRequired - level.pointsRequired) * 100 : 100;
